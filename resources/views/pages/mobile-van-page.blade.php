    ...
    <div class="mobile-van-page">
        ...
        <div id="why-hart" class="why-hart">
            <div class="van-title-text">
                ...
                <p>From weddings and birthdays to wild garden dos and swanky corporate soirées, we roll in with beautiful
                    bars,
        ...
        <form action="{{ route('contact.submit') }}" method="POST" class="contact-form">
            ...
            <div class="fs-field">
                <label class="fs-label" for="event-date">Date Of Event</label>
                <input type="text" class="fs-input" value="{{ old('event-date') }}" id="event-date" name="event-date" required></input>
            </div>
            <div class="fs-field">
        ...
        <script>
            ...
            const elem = document.querySelector('input[name="event-date"]');

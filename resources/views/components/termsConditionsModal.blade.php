    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Masterclass Terms & Conditions</h1>
            ...
            <div class="modal-body">
                <ul>
                    ...
                    <li>£37pp</li>
                    <li>All participants must be over 18 years of age</li>
                    <li>Non-alcoholic options are available upon request</li>
                </ul>
            </div>
